                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      ...specs.map((s) => _SpecChip(
                        label: s, selected: _selectedSpec == s,
                        onTap: () => setState(
              ...
              SliverToBoxAdapter(
                child: EmptyState(
                  message: _query.isNotEmpty || _selectedSpec != null
                      ? 'No doctors match your search' : 'No doctors found',
...
class _DoctorCard extends StatelessWidget {
  ...
  const _DoctorCard({
    required this.doctor, required this.canBook,
    required this.onBook, required this.onChat,
  });
