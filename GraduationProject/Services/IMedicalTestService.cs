...
namespace GraduationProject.Services
{
    public interface IMedicalTestService
    {
        ...
        Task<PagedResponse<MedicalTestResponse>> GetByPatientIdsAsync(IEnumerable<int> patientIds, int pageNumber = 1, int pageSize = 10, CancellationToken cancellationToken = default);
